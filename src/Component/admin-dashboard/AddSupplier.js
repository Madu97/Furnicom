    ...
    const registerform = (data) => {
        ...
        Axios.get('http://localhost:3001/checkusername', {
            ...
            if (response1.data[0]) {
                ...
                setusernamemsg("");
                Axios.post('http://localhost:3001/addsup', {
                    username: data.username,
                ...
                <div className="w-75 mx-auto shadow-lg p-5 ">
                    <div className="ui">
                        <form id="custmer-signup" className="form-group fs-15" onSubmit={handleSubmit(registerform)}>
                            <div className=" container">
                                <h2 className="text-center mb-4">Add a Supplier</h2>
                            </div>
                            ...
                            <div className="d-flex justify-content-end">
                                <button type="submit" class="btn btn-lg btn-primary">Add Supplier</button>
                            </div>
                        </form>
                    </div>
                </div>
