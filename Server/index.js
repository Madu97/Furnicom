...
app.get('/updatedeliver', (req, res) => {
    db.query("UPDATE delivery_person SET firstname=?, lastname=?, ic_no=?, phone_no=?, email=?, address=?  WHERE id = ?;", [req.query.fname, req.query.lname, req.query.ic_no, req.query.phone, req.query.email, req.query.address, req.query.id], (err, result) => {
        console.log(result);
        res.send(result);
...
app.get('/updatesupplier', (req, res) => {
    db.query("UPDATE supplier SET firstname=?, lastname=?, ic_no=?, phone_no=?, email=?, address=?  WHERE id = ?;", [req.query.fname, req.query.lname, req.query.ic_no, req.query.phone, req.query.email, req.query.address, req.query.id], (err, result) => {
        console.log(result);
        res.send(result);
...
app.get('/updateproduct', (req, res) => {
    db.query("UPDATE products SET name=?, description=?, timber_type=?, timber_quality=?, price=?, available_quantity=?  WHERE id = ?;", [req.query.name, req.query.description, req.query.timbertype, req.query.timberqua, req.query.price, req.query.quantity, req.query.id], (err, result) => {
        console.log(result);
        res.send(result);
...
app.get('/getsupplierbyid', (req, res) => {
    db.query("SELECT * FROM supplier WHERE id=?", [req.query.id], (err, result) => {
        console.log(req.query.id);
        res.send(result);
...
app.get('/getdeliverbyid', (req, res) => {
    db.query("SELECT * FROM delivery_person WHERE id=?", [req.query.id], (err, result) => {
        console.log(req.query.id);
        res.send(result);
